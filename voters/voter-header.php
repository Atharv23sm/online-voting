...
<div class="header">
    ...
    <div class="header-logo-container">
        ...
        <div class="header-logo">
            <a style="text-decoration: none" href="home.php"><span style="color:#005904">e</span><span style="color:#002061">VOTER</span></a>
        </div>
    ...
    <div class="navbar" id="navbar">
        <ul>
            ...
            <li onclick="showContact()" style="cursor: pointer; color:#fff">Contact us</a></li>
